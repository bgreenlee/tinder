...
describe Tinder::Connection do
  describe "authentication" do
    it "should raise an exception with bad credentials" do
      ...
      connection = Tinder::Connection.new('test', :token => 'foo', :ssl => false)
    ...
    it "should lookup token when username/password provided" do
      ...
      connection = Tinder::Connection.new('test', :username => 'user', :password => 'pass', :ssl => false)
    ...
    it "should use basic auth for credentials" do
      ...
      connection = Tinder::Connection.new('test', :token => 'mytoken', :ssl => false)
